...
class UploadStepParameters(StrictWorkflowStepModel):
    file_value_key: str = Field(min_length=1, max_length=200)


class UploadWorkflowStep(StrictWorkflowStepModel):
    action_type: Literal[WorkflowStepType.UPLOAD] = WorkflowStepType.UPLOAD
    selector_candidates: list[WorkflowSelectorCandidate] = Field(min_length=1, max_length=20)
    parameters: UploadStepParameters
